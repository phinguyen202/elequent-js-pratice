(function() {
    ...
    class Animation {
      ...
      updateView() {
        console.log(`Moved to ${this.worldState.place}`);
  ...
  class VillageState {
    ...
    move(destination) {
      console.log("destination: "+destination+ "; this.place: "+ this.place);
  ...
  window.runRobotAnimation(VillageState.random(), routeRobot, []);
