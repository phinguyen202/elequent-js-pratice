/**
 * Level hold the map of the game 
 *
 * @class Level
 */
class Level {
     ...
     * Analyze the plan and set height, width, startActors and rows map for the Level
     * @param {*} plan
     * @memberof Level
     */
    constructor(plan) {
...
/**
 * The State hold the Level, actor (player, coin, lava) and the status of game
 *
 * @class State
 */
class State {
...
class Player {
    ...
    /**
     * create a player with the y-alias position is subtract 0.5 
     *
     * @static
     * @param {*} pos
     * @returns
